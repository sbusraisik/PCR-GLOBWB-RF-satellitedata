...
outputDir <- 'C:/Users/sbusr/Desktop/Tez/Practical/data/viz/'
...
if (regions[1] == 'all'){
  ...
  colors <- c('#E69F00', '#ffdf20', '#17FF00','#0029F8','#1f78b4', '#33a02c', '#e31a1c', 'pink')
}else{
...
for (c in regions){
  ...
  ggsave(paste0('C:/Users/sbusr/Desktop/Practical/data/viz/1ecdf_', c, '.pdf'),plot,height=20, width=20, units='in', dpi=600) 
}