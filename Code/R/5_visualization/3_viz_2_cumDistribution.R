...
outputDir <- 'C:/Users/sbusr/Desktop/Practical/data/viz/'
...
for (c in regions){
  ...
  ggsave(paste0('C:/Users/sbusr/Desktop/Practical/data/viz/pdf_ecdf_', c, '.pdf'),plot,height=20, width=20, units='in', dpi=600) 
}