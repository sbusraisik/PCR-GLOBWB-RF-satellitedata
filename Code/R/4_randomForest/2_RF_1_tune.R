...
for (country in countries){
  if (country =='US'){
    gridnames <- c('predictors_pcr', 'predictors_pcr_sat_add','predictors_pcr_sat','predictors_sat_meteo',
                   'predictors_sat_meteo_static','predictors_pcr_sat_pr_add','predictors_pcr_sat_pr',
                   'predictors_pcr_sat_E_add','predictors_pcr_sat_E','predictors_meteo_static','predictors_sat_static')
  }else{
    print("NO")
  }
  tuned_mtry <- list()
